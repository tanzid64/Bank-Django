...
from .froms import DepositForm, WithdrawForm, LoanRequestForm, TransferRequestForm
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, 'Loan Request Message', 'transactions/loan_mail.html')
        return super().form_valid(form)
...
class TransferMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        amount = form.cleaned_data.get('amount')
        beneficiary_account = UserBankAccount.objects.get(account_no = form.cleaned_data.get('account_no'))
        self.request.user.account.balance -= amount
        ...
        send_transaction_email(self.request.user, amount,'Transaction Report: Transfer','transactions/transfer_mail.html')
        send_transaction_email(beneficiary_account.user, amount,'Transaction Report: Transfer','transactions/transfer_mail.html')
        return super().form_valid(form)